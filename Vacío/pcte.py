...
plt.ylabel("Presión [Torr]")
plt.grid(color="gray", linestyle="-", linewidth=0.5)
plt.plot(pcteBM[0].index, pcteBM[0]["Presión"],".", label="Medición pcteBM1")
plt.plot(pcteBM[2].index, pcteBM[2]["Presión"],".", label="Medición pcteBM3")
plt.plot(pcteBM[3].index, pcteBM[3]["Presión"],".", label="Medición pcteBM4")
plt.plot(pcteBM[4].index, pcteBM[4]["Presión"],".", label="Medición pcteBM5")
plt.legend()
...
plt.plot(pcteBD[0].index, pcteBD[0]["Presión"],".", label="Medición pcteBD1")
plt.plot(pcteBD[1].index, pcteBD[1]["Presión"],".", label="Medición pcteBD2")
plt.plot(pcteBD[2].index, pcteBD[2]["Presión"],".", label="Medición pcteBD3")
# plt.plot(pcteBD[3].index, pcteBD[3]["Presión"],".", label="pcteBD4")
plt.plot(pcteBD[4].index, pcteBD[4]["Presión"],".", label="Medición pcteBD5")
plt.legend()
